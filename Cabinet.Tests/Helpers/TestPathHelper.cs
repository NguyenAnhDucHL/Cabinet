namespace Cabinet.Tests.Helpers
{
    internal static class TestPathHelper
    {
        public static string GetRepoRoot()
        {
            ...
            while (dir != null)
            {
                bool hasCore = Directory.Exists(Path.Combine(dir.FullName, "Cabinet.Core"));
            ...
            throw new DirectoryNotFoundException("Không tìm thấy thư mục root của repo Cabinet.");
        }
        ...
        public static string GetCoreTessdataPath() => Path.Combine(GetRepoRoot(), "Cabinet.Core", "tessdata");
