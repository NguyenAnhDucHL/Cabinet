...
namespace Cabinet.Tests.Helpers
{
    public static class AutomationDocHelper
    {
        ...
        private const string FullContentTemplate =
            ...
            "Sở Thông tin và Truyền thông xác định việc triển khai Hệ thống Phòng họp không giấy tờ tích hợp trí tuệ nhân tạo (AI) là nhiệm vụ trọng tâm nhằm nâng cao hiệu quả quản lý hành chính nhà nước.\n\n" +
        ...
        private const string LongAdministrativeTemplate =
            "Căn cứ Quyết định số 749/QĐ-TTg ngày 03/6/2020 của Thủ tướng Chính phủ phê duyệt 'Chương trình Chuyển đổi số quốc gia đến năm 2025, định hướng đến năm 2030';\n" +
            "Sở Thông tin và Truyền thông xác định việc triển khai Hệ thống Phòng họp không giấy tờ tích hợp trí tuệ nhân tạo (AI) là nhiệm vụ trọng tâm nhằm nâng cao hiệu quả quản lý hành chính nhà nước, hiện thực hóa mục tiêu chuyển đổi số toàn diện của tỉnh.\n" +
            "Để đảm bảo đúng tiến độ đề ra, Giám đốc Sở yêu cầu các phòng, đơn vị trực thuộc tập trung thực hiện các nội dung sau:\n" +
