...
namespace Cabinet.Tests
{
    public class RuleExtractionTests : IntegrationTestBase
    {
        ...
        private void SetupTestData()
        {
            ...
            var adminRepo = scope.ServiceProvider.GetRequiredService<Cabinet.Core.Data.Interfaces.IAdminRepository>();
            var settingRepo = scope.ServiceProvider.GetRequiredService<Cabinet.Core.Data.Interfaces.ISettingRepository>();
