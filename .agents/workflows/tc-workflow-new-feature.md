...
3. Xác định tính năng mới thuộc module nào: `auth`, `meetings`, `proceedings`, `conclusions`, `notes`, `users`, `admin`, `notify`.
...
Xem [`tc-workflow-git-push.md`](tc-workflow-git-push.md).
