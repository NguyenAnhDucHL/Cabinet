namespace ToolCalendar.Tests.Helpers
{
    internal static class TestPathHelper
    {
        public static string GetRepoRoot()
        {
            ...
            while (dir != null)
            {
                bool hasCore = Directory.Exists(Path.Combine(dir.FullName, "ToolCalendar.Core"));
        ...
        public static string GetCoreTessdataPath() => Path.Combine(GetRepoRoot(), "ToolCalendar.Core", "tessdata");
