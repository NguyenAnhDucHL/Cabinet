  ...
  return (
    <div className="flex flex-col md:flex-row md:items-center justify-between gap-2 px-1 shrink-0">
      <div className="flex flex-col gap-0 border-l-4 border-primary pl-3 py-0.5">
        <h2 className="text-xl font-extrabold tracking-tight text-foreground">Bảng điều hành công văn</h2>
      ...
      <div className="flex items-center gap-2">
        <div className="relative w-full md:w-80">
          ...
          <Input
            ...
            className="h-9 pl-9 pr-3 bg-card"
          />
        </div>
        ...
        {canUpload && (
          <Button className="h-9 shrink-0 font-bold" onClick={onUpload}>
