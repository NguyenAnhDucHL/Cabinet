  ...
  const tableRows = [
    ...
    new TableRow({
      children: [
        ...
        new TableCell({
          children: [new Paragraph({ children: [new TextRun({ text: "Đơn vị / Phòng ban", bold: true })], alignment: AlignmentType.CENTER })],
          rowSpan: 2,
          verticalAlign: "center",
        }),
        new TableCell({
          children: [new Paragraph({ children: [new TextRun({ text: "Tổng nhận", bold: true })], alignment: AlignmentType.CENTER })],
          rowSpan: 2,
          verticalAlign: "center",
        }),
        new TableCell({
          children: [new Paragraph({ children: [new TextRun({ text: "Đã xử lý", bold: true })], alignment: AlignmentType.CENTER })],
          columnSpan: 2,
        }),
        new TableCell({
          children: [new Paragraph({ children: [new TextRun({ text: "Đang giải quyết", bold: true })], alignment: AlignmentType.CENTER })],
          columnSpan: 2,
        }),
      ],
    }),
    ...
    new TableRow({
      children: [
        new TableCell({ children: [new Paragraph({ children: [new TextRun({ text: "Đúng hạn", bold: true })], alignment: AlignmentType.CENTER })] }),
        new TableCell({ children: [new Paragraph({ children: [new TextRun({ text: "Quá hạn", bold: true })], alignment: AlignmentType.CENTER })] }),
        new TableCell({ children: [new Paragraph({ children: [new TextRun({ text: "Trong hạn", bold: true })], alignment: AlignmentType.CENTER })] }),
        new TableCell({ children: [new Paragraph({ children: [new TextRun({ text: "Quá hạn", bold: true })], alignment: AlignmentType.CENTER })] }),
      ],
    }),
  ];
    ...
    tableRows.push(
      new TableRow({
        children: [
          ...
          new TableCell({ children: [new Paragraph({ text: row.total.toString(), alignment: AlignmentType.CENTER })] }),
          new TableCell({ children: [new Paragraph({ text: row.onTime.toString(), alignment: AlignmentType.CENTER })] }),
          new TableCell({ children: [new Paragraph({ text: row.overdue.toString(), alignment: AlignmentType.CENTER })] }),
          new TableCell({ children: [new Paragraph({ text: row.processingOnTime.toString(), alignment: AlignmentType.CENTER })] }),
          new TableCell({ children: [new Paragraph({ text: row.processingOverdue.toString(), alignment: AlignmentType.CENTER })] }),
        ],
      })
    );
  });
  ...
  tableRows.push(
    new TableRow({
      children: [
        ...
        new TableCell({ children: [new Paragraph({ children: [new TextRun({ text: totalReceived.toString(), bold: true })], alignment: AlignmentType.CENTER })] }),
        new TableCell({ children: [new Paragraph({ children: [new TextRun({ text: totalOnTime.toString(), bold: true })], alignment: AlignmentType.CENTER })] }),
        new TableCell({ children: [new Paragraph({ children: [new TextRun({ text: totalOverdue.toString(), bold: true })], alignment: AlignmentType.CENTER })] }),
        new TableCell({ children: [new Paragraph({ children: [new TextRun({ text: totalProcOnTime.toString(), bold: true })], alignment: AlignmentType.CENTER })] }),
        new TableCell({ children: [new Paragraph({ children: [new TextRun({ text: totalProcOverdue.toString(), bold: true })], alignment: AlignmentType.CENTER })] }),
      ],
    })
  );
    ...
    sections: [
      {
        ...
        children: [
          ...
          new Paragraph({
            children: [new TextRun({ text: "Tình hình tiếp nhận và xử lý văn bản đến", bold: true, size: 28 })],
            alignment: AlignmentType.CENTER,
          }),
          new Paragraph({
            ...
            rows: [
              new TableRow({
                children: [
                  ...
                  new TableCell({
                    children: [
                      new Paragraph({ children: [new TextRun({ text: "CHÁNH VĂN PHÒNG", bold: true, size: 26 })], alignment: AlignmentType.CENTER }),
