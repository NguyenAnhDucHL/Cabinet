...
- [X] Khởi tạo các Entity trong `Cabinet.Core` (User, Document, Department, Label, Rule, Setting, AuditLog). 🔹 *Next: Đã hoàn thành. Sẵn sàng cho việc phân quyền và điều phối.*
