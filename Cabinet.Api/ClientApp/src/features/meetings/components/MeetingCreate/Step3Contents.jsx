      ...
      <div className="flex border-b border-gray-200">
        {contentTabs.map((tab) => (
          <div
            ...
            className={`flex items-center px-4 py-2 border-b-2 cursor-pointer transition-colors ${activeContentTab === tab.id ? 'border-[var(--color-primary)] text-[var(--color-primary)] font-semibold' : 'border-transparent text-gray-500 hover:text-gray-700 font-medium'}`}
          >
            <span>{tab.title}</span>
