...
using System.Text;
using Cabinet.Api.Security;          // ✅ CustomUserStore, HybridPasswordHasher
...
using Cabinet.Middleware;   // ✅ FileAccessSecurityMiddleware
using Cabinet.Policies;    // ✅ AppPolicies (phân quyền tập trung)
using Cabinet.Services.Security; // ✅ ClamAvService, BackupService
...
builder.Services.AddScoped<Cabinet.Core.Data.Repositories.IReportRepository, Cabinet.Core.Data.Repositories.ReportRepository>();
builder.Services.AddScoped<Cabinet.Core.Data.Interfaces.IMeetingExecutionRepository, Cabinet.Core.Data.Repositories.MeetingExecutionRepository>();
...
builder.Services.AddCors(options =>
{
    options.AddPolicy("AllowAll",
        policy => policy
            // Cho phép: localhost (dev), localtunnel (staging), và IP LAN nội bộ
...
app.UseMiddleware<Cabinet.Api.Middleware.GlobalExceptionMiddleware>();
...
forwardedOptions.KnownIPNetworks.Clear(); // Tin tưởng mọi mạng (cần thiết cho proxy bên ngoài)
